            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">{{ $TotalAlbum }}</h4>
            ...
            <div class="col-lg-6 col-md-12 col-6 mb-6">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <h4 class="card-title mb-3">{{ $TotalPhoto }}</h4>
    ...
    <div class="col-12 col-md-8 col-lg-12 col-xxl-4 order-3 order-md-2 profile-report">
        <div class="row">
            <div class="col-6 mb-6 payments">
                <div class="card h-100">
                    <div class="card-body">
                        <p class="mb-1">Album Active</p>
                        <h4 class="card-title mb-3">{{ $AlbumActive }}</h4>
            ...
            <div class="col-6 mb-6 transactions">
                <div class="card h-100">
                    <div class="card-body">
                        <p class="mb-1">Photo Approved </p>
                        <h4 class="card-title mb-3">{{ $PhotoApproved }}</h4>
